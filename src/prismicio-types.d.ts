...
export interface BentoSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
	 */
	repeatable_zone: prismic.GroupField<Simplify<BentoSliceDefaultPrimaryRepeatableZoneItem>>;
}
...
export interface CaseStudiesSliceDefaultPrimaryRepeatableZoneItem {
	...
	case_study: ContentRelationshipFieldWithData<
		[
			{
				id: 'case_study';
				fields: ['company', 'description', 'image', 'meta_title', 'meta_description', 'meta_image'];
			}
		]
	>;
}
...
export interface CaseStudiesSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
	 */
	repeatable_zone: prismic.GroupField<Simplify<CaseStudiesSliceDefaultPrimaryRepeatableZoneItem>>;
}
